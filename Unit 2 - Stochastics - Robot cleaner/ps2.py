...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        self.grid[int(pos.getY())][int(pos.getX())] = 1
    ...
    def updatePositionAndClean(self):
        ...
        if not self.room.isPositionInRoom(newPos):
            while not self.room.isPositionInRoom(newPos):
                newDir = random.randrange(360)
                newPos = self.position.getNewPosition(newDir,self.speed)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        while room.getNumCleanedTiles() < min_coverage*room.width*room.height:
    ...
    return sum(time)/len(time)/num_robots
# Uncomment this line to see how much your simulation takes on average
print(runSimulation(2,1.0,8,8,.80,30, StandardRobot))
...
#showPlot1('Time to clean a room', 'number of robots', 'time')
#
...
#     plot.
#
#showPlot2('Time to clean a room','aspect ratio', 'time')
#
